...
static const AVOption rtmp_options[] = {
    ...
    {"rtmp_rw_timeout", "Maximum timeout (in milliseconds) to wait for incoming packets. -1 is infinite. Implies -rtmp_listen 1",  OFFSET(rw_timeout), AV_OPT_TYPE_INT, {.i64 = -1}, INT_MIN, INT_MAX, DEC, "rtmp_listen"},
    { NULL },
};

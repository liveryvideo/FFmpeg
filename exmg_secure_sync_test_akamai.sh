...
export FF_EXMG_SECURE_SYNC_KEY_INDEX_MAX_WINDOW="60" # nb of key-scopes held in file-written index (int) (negative -> unlimited)
...
export FF_EXMG_SECURE_SYNC_FS_PUB_MAX_AGE_SECONDS=2400
